...
function BuyWinkBlinkingScreen({ navigation, route }) {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: Constants.COLOR.SECONDARY }} >
            ...
            <Image style={{ width: Constants.LAYOUT.SCREEN_WIDTH, height: (320 / 480) * Constants.LAYOUT.SCREEN_WIDTH, resizeMode: 'cover', borderBottomLeftRadius: 20, borderBottomRightRadius: 20 }} source={require('../../../assets/images/img_winky.jpeg')} />
                ...
                <View style={{ flex: 1, paddingTop: 30, width: Constants.LAYOUT.SCREEN_WIDTH, paddingHorizontal: 30 }}>
                    <ScrollView style={{ flex: 1 }}>
                        ...
                        <Text style={{ marginTop: 25, textAlign: 'center', alignSelf: 'center', fontFamily: Constants.FONT_FAMILY.PRIMARY_MEDIUM, fontSize: Constants.FONT_SIZE.FT24, color: Constants.COLOR.WHITE }}>
                            {'Participate in one-hour speed dating sessions twice a month.'}
                        </Text>
                    </ScrollView>
                </View>
...
export default BuyWinkBlinkingScreen;
        ...
        <View style={{ flex: 1, backgroundColor: Constants.COLOR.SECONDARY }} >
            ...
            <View style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'center', paddingBottom: insets.bottom + 24 }}>
                ...
                <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 30, paddingBottom: 20, alignItems: 'center' }}>
                    <Text style={{ textAlign: 'center', lineHeight: 26, marginTop: 30, fontFamily: Constants.FONT_FAMILY.PRIMARY_MEDIUM, fontSize: Constants.FONT_SIZE.FT22, color: Constants.COLOR.WHITE }}>
                        {"Please help us learn a little more about you, so that we can match you with other members that are most compatible with you."}
                    </Text>
                </ScrollView>

...
const MatchItem = ({ item, layout, index, onUserPress, onMatchPress }) => {
    ...
    return (
        <View style={{
            ...
            <TouchableOpacity onPress={onUserPress} style={{
                ...
                {/* <Image style={{ width: '100%', height: '100%', borderRadius: 10, resizeMode: 'contain' }} source={getS3StorageURL('1695233300441.jpg')} /> */}
            ...
            <TouchableOpacity onPress={onMatchPress}>

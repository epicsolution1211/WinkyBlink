    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          {
            props.removeable &&
            <TouchableOpacity onPress={props.onRemovePress} style={{ marginStart: 10, width: 22, height: 22, borderRadius: 24, backgroundColor: 'red', alignItems: 'center', justifyContent: 'center' }}>
              <Image style={{ width: 11, height: 11, tintColor: 'white', resizeMode: 'contain' }} source={require('../../../assets/images/ic_remove_interest.png')} />
            </TouchableOpacity>
          }
        </View>
      </TouchableOpacity>
